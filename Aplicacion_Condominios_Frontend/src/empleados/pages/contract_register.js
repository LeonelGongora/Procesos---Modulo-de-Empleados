...
function ContractRegister() {
  ...
  /*--------------------------------*/
  /* Mejoras al HU asignar contrato */
  ...
  //const [selectedBeneficio, setSelectedBeneficio] = useState("Seleccione beneficios");
  /*--------------------------------*/
                  ...
                  <MDBCol md="9" className="pe-5">
                    ...
                    >
                      ...
                      {beneficiosSelect.map((beneficio) => {
                        return (
                          <>
                            <option key={beneficio.nombre} value={beneficio.nombre}>
                              {beneficio.nombre}
                            </option>
                          </>
                        );
                                  ...
                                  <td>
                                    {
                                      ...
                                      "S/C" : beneficioL.costo_empresa
                                    }
                                  </td>
                                  <td>
                                    {
                                      beneficioL.costo_empleado === 0 ?
                                      "S/C" : beneficioL.costo_empleado
                                    }
                                  </td>
                                  <td>
                                    <Button
                                      ...
                                      onClick={()=> eliminarBeneficioLista(beneficioL)}
                                    >
                                      x
                                    </Button>
                                  </td>
